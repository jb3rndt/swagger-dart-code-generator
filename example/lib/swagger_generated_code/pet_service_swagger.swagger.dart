...
abstract class PetServiceSwagger extends ChopperService {
  ...
  Future<chopper.Response> petPost({
    ...
    if (_handleConnection != null) {
      return await _handleConnection!(() async {
        return await _petPost(
          body: body,
          cacheControl: cacheControl?.toString(),
        );
      });
    } else {
      return await _petPost(body: body, cacheControl: cacheControl?.toString());
    }
  }
  ...
  Future<chopper.Response> petPut({
    ...
    if (_handleConnection != null) {
      return await _handleConnection!(() async {
        return await _petPut(
          body: body,
          cacheControl: cacheControl?.toString(),
        );
      });
    } else {
      return await _petPut(body: body, cacheControl: cacheControl?.toString());
    }
  }
  ...
  Future<chopper.Response<List<Pet>>> petFindByStatusGet({
    ...
    if (_handleConnection != null) {
      return await _handleConnection!(() async {
        return await _petFindByStatusGet(
  ...
  Future<chopper.Response<List<Pet>>> petFindByTagsGet({
    ...
    if (_handleConnection != null) {
      return await _handleConnection!(() async {
        return await _petFindByTagsGet(
          tags: tags,
          cacheControl: cacheControl?.toString(),
        );
      });
  ...
  Future<chopper.Response<ApiResponse>> petPetIdUploadImagePost({
    ...
    if (_handleConnection != null) {
      return await _handleConnection!(() async {
        return await _petPetIdUploadImagePost(
          petId: petId,
  ...
  Future<chopper.Response<Object>> storeInventoryGet({
    ...
    if (_handleConnection != null) {
      return await _handleConnection!(() async {
        return await _storeInventoryGet(
          apiKey: apiKey?.toString(),
          cacheControl: cacheControl?.toString(),
        );
      });
  ...
  Future<chopper.Response<Order>> storeOrderOrderIdGet({
    ...
    if (_handleConnection != null) {
      return await _handleConnection!(() async {
        return await _storeOrderOrderIdGet(
          orderId: orderId,
          cacheControl: cacheControl?.toString(),
        );
      });
  ...
  Future<chopper.Response> storeOrderOrderIdDelete({
    ...
    if (_handleConnection != null) {
      return await _handleConnection!(() async {
        return await _storeOrderOrderIdDelete(
          orderId: orderId,
          cacheControl: cacheControl?.toString(),
        );
      });
  ...
  Future<chopper.Response> userCreateWithArrayPost({
    ...
    if (_handleConnection != null) {
      return await _handleConnection!(() async {
        return await _userCreateWithArrayPost(
          body: body,
          cacheControl: cacheControl?.toString(),
        );
      });
  ...
  Future<chopper.Response> userCreateWithListPost({
    ...
    if (_handleConnection != null) {
      return await _handleConnection!(() async {
        return await _userCreateWithListPost(
          body: body,
          cacheControl: cacheControl?.toString(),
        );
      });
  ...
  Future<chopper.Response> userLogoutGet({dynamic cacheControl}) async {
    if (_handleConnection != null) {
      return await _handleConnection!(() async {
        return await _userLogoutGet(cacheControl: cacheControl?.toString());
      });
    } else {
      return await _userLogoutGet(cacheControl: cacheControl?.toString());
    }
  ...
  Future<chopper.Response> userUsernameDelete({
    ...
    if (_handleConnection != null) {
      return await _handleConnection!(() async {
        return await _userUsernameDelete(
          username: username,
          cacheControl: cacheControl?.toString(),
        );
      });
