...
Map<String, dynamic> _$GeneratorOptionsToJson(GeneratorOptions instance) =>
    <String, dynamic>{
      ...
      'inheritance_value_map': instance.inheritanceValueMap,
...
InheritanceValueMap _$InheritanceValueMapFromJson(Map<String, dynamic> json) =>
    InheritanceValueMap(
      superClass: json['super_class'] as String? ?? '',
